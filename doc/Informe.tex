...
Para iniciar una votación, los dos servidores deben estar ejecutándose y deben estar configurados correctamente (con las votaciones, opciones y votantes cargados). En los clientes, los votantes deben incluir su clave privada en el directorio \verb#resources/votantes# para poder comenzar.

...
Como es sistema de 4 componenete que pueden intercambiar datos entre ellos
...
estado interno y retornar una salida. Para ello, requieren de 2 puntos de 
...
El cliente merece una mensión aparte, ya que a él ingresan datos de 3 lugares:
...
1 &	Teclado				&		& 	(1) Votante\\ \hline
2 & Sistema de archivos	&		&	(1) Votante\\ \hline 
3 &	Sockets				&		& 	(???) \verb·Auth1·\\
  &			& 		&	(???) \verb·Auth2·\\
  &			&		&	(???) \verb·Votos·\\ \hline
\end{tabular}
...
\begin{tabular}{|c|c|c|c|} \hline
\textbf{ID} & \textbf{Nombre} & \textbf{Descripción} & \textbf{Trust levels} \\ \hline
1 &	Base de Datos	&		& 	(???) \verb.Auth1.\\ \hline
2 &	Sockets			&		& 	(???) \verb·Votante·\\
  &					&		&	(???) \verb·Votos·\\ \hline
\end{tabular}
...
\begin{tabular}{|c|c|c|c|} \hline
\textbf{ID} & \textbf{Nombre} & \textbf{Descripción} & \textbf{Trust levels} \\ \hline
1 &	Base de Datos	&		& 	(???) \verb.Auth2.\\ \hline
2 &	Sockets			&		& 	(???) \verb·Votante·\\
  &					&		&	(???) \verb·Votos·\\ \hline
\end{tabular}
...
\begin{tabular}{|c|c|c|c|} \hline
\textbf{ID} & \textbf{Nombre} & \textbf{Descripción} & \textbf{Trust levels} \\ \hline
1 &	Base de Datos	&		& 	(???) \verb.Votos.\\ \hline
2 &	Sockets			&		& 	(???) \verb·Votante·\\
  &					&		&	(???) \verb·Auth1·\\
  &					&		&	(???) \verb·Auth2·\\ \hline
\end{tabular}
...
2	& Registros				&		& 	\\ \hline
3	& Anonimato				&		&	\\ \hline
4	& Claves privadas		&		&	\\ \hline
5	& Contraseñas			&		&	\\ \hline
6	& Consistencia de 		&		&	\\ 
	& la base de datos		&		&	\\ \hline
7	& Integridad de los 	&		&	\\ 
	& datos intercambiados	&		&	\\ \hline
